        ...
        <div style="display: grid; grid-template-columns: 280px 1fr; gap: 32px;">
            ...
            <div>
                ...
                <div class="pagination" style="margin-top: 48px;">
                    <?php if ($page > 1): ?>
                    <a href="<?php echo SITE_URL; ?>/products.php?page=<?php echo $page - 1; ?><?php echo $category ? '&category=' . $category : ''; ?><?php echo $search ? '&search=' . urlencode($search) : ''; ?><?php echo $sort !== 'newest' ? '&sort=' . $sort : ''; ?>">
                    ...
                    <?php else: ?>
                    <a href="<?php echo SITE_URL; ?>/products.php?page=<?php echo $i; ?><?php echo $category ? '&category=' . $category : ''; ?><?php echo $search ? '&search=' . urlencode($search) : ''; ?><?php echo $sort !== 'newest' ? '&sort=' . $sort : ''; ?>">
                        <?php echo $i; ?>
                    </a>
                    <?php endif; ?>
                    <?php endfor; ?>
